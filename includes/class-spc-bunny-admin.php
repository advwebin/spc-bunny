                ...
                <div class="spc-bunny-card">
                    ...
                    <div class="spc-bunny-rules-list">
                        ...
                        $rules = [
                            ...
                            SPC_Bunny_Edge_Rules::RULE_BYPASS_POST          => [ '&#128394;', __( '8b. Bypass cache: POST requests',             'spc-bunny' ), __( 'All HTTP POST requests (form submissions, AJAX writes) bypass cache entirely — even with Force Cache active.', 'spc-bunny' ), true ],
